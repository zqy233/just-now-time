...
export function nowTimeObj(s = "-", S = ":") {
    const dt = new Date()
    const y = dt.getFullYear()
    const m = (dt.getMonth() + 1 + "").padStart(2, "0")
    const d = (dt.getDate() + "").padStart(2, "0")
...
export function formatTimeObj(t = new Date(), s = "-", S = ":") {
    const dt = new Date(t)
    const y = dt.getFullYear()
    const m = (dt.getMonth() + 1 + "").padStart(2, "0")
    const d = (dt.getDate() + "").padStart(2, "0")
...
export function timeCnObj(s = new Date(), b = true) {
    const dt = new Date(s)
    const y = dt.getFullYear()
    if (b) {
        const m = dt.getMonth() + 1 + ""
        ...
        const ss = dt.getSeconds() + ""
        return {
            full: `${y}年${m}月${d}日 ${hh}时${mm}分${ss}秒`,
            date: `${y}年${m}月${d}日`,
            time: `${hh}时${mm}分${ss}秒`
        }
    }
